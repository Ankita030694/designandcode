...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://designncode.com/services/seo/performance-marketing',
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://designncode.com/images/infographics/seo-performance-marketing.jpg",
        width: 1200,
        height: 675,
  ...
  twitter: {
    ...
    title: "SEO for Performance Marketing & Organic Growth Architecture | DesignNCode",
    description: "Enterprise technical SEO architecture integrated with performance marketing funnels, Generative Engine Optimization, and high-velocity organic revenue systems.",
    images: ["https://designncode.com/images/infographics/seo-performance-marketing.jpg"],
  },
};
