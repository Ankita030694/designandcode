  ...
  const schemaData = {
    ...
    "@graph": [
      ...
      "mainEntity": [
            {
                  "@type": "Question",
                  "name": "How do you scale paid customer acquisition for Manchester D2C fashion and retail brands?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "We deploy full-funnel media buying architectures across Meta Advantage+, TikTok Shop, and Google Performance Max. By coupling dynamic catalog feeds with rapid creative iteration and real-time margin data, we scale monthly ad spend while maintaining aggressive contribution margins."
                  }
            },
            {
                  "@type": "Question",
                  "name": "Why is server-side Meta Conversions API (CAPI) essential for North West e-commerce?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Client-side browser pixels routinely lose 20-30% of purchase signals due to ad blockers and iOS privacy settings. Our Cloudflare Worker container dispatches server-side purchase and add-to-cart events directly to ad networks, restoring lost data and improving algorithmic targeting."
                  }
            },
            {
                  "@type": "Question",
                  "name": "How do you prevent ad spend waste across Google Performance Max and Search campaigns?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "We deploy custom value-based bidding scripts, negative search query rules, and placement whitelists. We feed real offline order margins and first-party CRM milestones back to Google's bidding algorithm to prevent bidding on cheap, non-converting queries."
                  }
            },
            {
                  "@type": "Question",
                  "name": "How do edge-rendered landing pages improve Quality Score and paid ROAS?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Our Next.js landing pages achieve sub-600ms load times on UK mobile networks. Google rewards this lightning performance with higher landing page experience scores, slashing cost-per-click (CPC) by up to 28% and eliminating paid visitor bounce rates."
                  }
            },
            {
                  "@type": "Question",
                  "name": "What multi-touch attribution models do you implement for complex consumer funnels?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "We deploy algorithmic incrementality testing combined with Markov chain attribution models. This quantifies the true revenue uplift generated by top-of-funnel TikTok and Meta discovery ads, replacing inaccurate last-click reporting."
                  }
            },
            {
                  "@type": "Question",
                  "name": "How do you ensure influencer and sponsored creative adheres to UK ASA regulations?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "We integrate automated ad creative compliance checks adhering to Advertising Standards Authority (ASA) and CAP Code guidelines, ensuring transparent promotional disclosures and risk disclaimers across all paid media channels."
                  }
            },
            {
                  "@type": "Question",
                  "name": "How do your tracking architectures maintain compliance with UK GDPR and ICO rules?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "We implement advanced Google Consent Mode v2 and server-side signal scrubbing, ensuring no personally identifiable information (PII) is shared without explicit consent, in full compliance with UK Information Commissioner's Office directives."
                  }
            },
            {
                  "@type": "Question",
                  "name": "What initial timeline is required to scale and optimize a paid acquisition campaign?",
                  "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Tracking architecture setup and creative testing happen within the first 14 days. Algorithmic bid stabilization and profitable budget scaling typically compound within weeks 4 through 8."
                  }
            }
      ]
}
          ...
          <article className="lg:col-span-6 flex flex-col space-y-12">
            ...
            <section id="faq" className="w-full bg-white/95 backdrop-blur-sm border border-zinc-200/80 rounded-3xl p-8 shadow-xs text-left scroll-mt-28">
              ...
              <div className="divide-y divide-zinc-200/80">
                {[
                  {
                    q: "How do you scale paid customer acquisition for Manchester D2C fashion and retail brands?",
                    a: "We deploy full-funnel media buying architectures across Meta Advantage+, TikTok Shop, and Google Performance Max. By coupling dynamic catalog feeds with rapid creative iteration and real-time margin data, we scale monthly ad spend while maintaining aggressive contribution margins."
                  },
                  {
                    q: "Why is server-side Meta Conversions API (CAPI) essential for North West e-commerce?",
                    a: "Client-side browser pixels routinely lose 20-30% of purchase signals due to ad blockers and iOS privacy settings. Our Cloudflare Worker container dispatches server-side purchase and add-to-cart events directly to ad networks, restoring lost data and improving algorithmic targeting."
                  },
                  {
                    q: "How do you prevent ad spend waste across Google Performance Max and Search campaigns?",
                    a: "We deploy custom value-based bidding scripts, negative search query rules, and placement whitelists. We feed real offline order margins and first-party CRM milestones back to Google's bidding algorithm to prevent bidding on cheap, non-converting queries."
                  },
                  {
                    q: "How do edge-rendered landing pages improve Quality Score and paid ROAS?",
                    a: "Our Next.js landing pages achieve sub-600ms load times on UK mobile networks. Google rewards this lightning performance with higher landing page experience scores, slashing cost-per-click (CPC) by up to 28% and eliminating paid visitor bounce rates."
                  },
                  {
                    q: "What multi-touch attribution models do you implement for complex consumer funnels?",
                    a: "We deploy algorithmic incrementality testing combined with Markov chain attribution models. This quantifies the true revenue uplift generated by top-of-funnel TikTok and Meta discovery ads, replacing inaccurate last-click reporting."
                  },
                  {
                    q: "How do you ensure influencer and sponsored creative adheres to UK ASA regulations?",
                    a: "We integrate automated ad creative compliance checks adhering to Advertising Standards Authority (ASA) and CAP Code guidelines, ensuring transparent promotional disclosures and risk disclaimers across all paid media channels."
                  },
                  {
                    q: "How do your tracking architectures maintain compliance with UK GDPR and ICO rules?",
                    a: "We implement advanced Google Consent Mode v2 and server-side signal scrubbing, ensuring no personally identifiable information (PII) is shared without explicit consent, in full compliance with UK Information Commissioner's Office directives."
                  },
                  {
                    q: "What initial timeline is required to scale and optimize a paid acquisition campaign?",
                    a: "Tracking architecture setup and creative testing happen within the first 14 days. Algorithmic bid stabilization and profitable budget scaling typically compound within weeks 4 through 8."
                  }
                ].map((faq, idx) => (
