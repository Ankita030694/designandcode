...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://designncode.com/services/ui-ux/manchester',
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://designncode.com/images/infographics/ui-ux-manchester.jpg",
        width: 1200,
        height: 675,
  ...
  twitter: {
    ...
    title: "UI/UX Design in Manchester | DesignNCode",
    description: "Enterprise UI/UX design systems and digital product architecture in Manchester. WCAG 2.2 AA compliance, FCA-aligned fintech interfaces, and e-commerce optimization.",
    images: ["https://designncode.com/images/infographics/ui-ux-manchester.jpg"],
  },
};
