...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://designncode.com/services/ui-ux-design/london',
  },
  title: "UI/UX Design in London | DesignNCode",
  description: "Enterprise UI/UX design systems and digital product architecture in London. WCAG 2.2 AA compliance, FCA-aligned fintech interfaces, and conversion optimization.",
  openGraph: {
    title: "UI/UX Design in London | DesignNCode",
    description: "Enterprise UI/UX design systems and digital product architecture in London. WCAG 2.2 AA compliance, FCA-aligned fintech interfaces, and conversion optimization.",
    ...
    images: [
      {
        url: "https://designncode.com/images/infographics/ui-ux-design-london.jpg",
        width: 1200,
        height: 675,
        alt: "UI/UX Design in London Infographic Blueprint",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "UI/UX Design in London | DesignNCode",
    description: "Enterprise UI/UX design systems and digital product architecture in London. WCAG 2.2 AA compliance, FCA-aligned fintech interfaces, and conversion optimization.",
    images: ["https://designncode.com/images/infographics/ui-ux-design-london.jpg"],
  },
};
        ...
        <div className="max-w-[1560px] mx-auto">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-zinc-950 leading-[1.08] mb-6">
              Enterprise UI/UX Design &amp; Digital Experience Architecture in London
            </h1>
              ...
              <div className="p-4 bg-zinc-50/80">
                <div className="rounded-xl overflow-hidden border border-zinc-200 bg-white">
                  <img
                    ...
                    alt="UI/UX Design in London Technical Architecture Infographic"
