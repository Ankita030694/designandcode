...
export const metadata: Metadata = constructCityMetadata({
  ...
  city: "Manchester",
  slug: "services/seo-and-organic-growth/manchester",
  customTitle: "Enterprise SEO & Growth in Manchester | DesignNCode",
  customDescription: "Enterprise SEO services and search growth architecture in Manchester. Core Web Vitals optimization, entity indexing & high rankings. Speak with our team.",
              ...
              <div className="p-4 bg-zinc-50/80">
                <div className="rounded-xl overflow-hidden border border-zinc-200 bg-white">
                  <img
                    ...
                    alt="SEO and Organic Growth in Manchester Technical Architecture Infographic" width={1200} height={675}
