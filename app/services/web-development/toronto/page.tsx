...
export const metadata: Metadata = {
  alternates: {
    canonical: 'https://designncode.com/services/web-development/toronto',
  },
  ...
  openGraph: {
    title: "Web Development in Toronto | DesignNCode",
    description: "Enterprise full-stack web development and Next.js cloud architecture in Toronto. Sub-second performance, AODA WCAG 2.2 AA compliance, and Bay Street fintech scalability.",
    url: "https://designncode.com/services/web-development/toronto",
    siteName: "DesignNCode",
    images: [
      {
        url: "https://designncode.com/images/infographics/web-development-toronto.jpg",
        width: 1200,
        height: 675,
  ...
  twitter: {
    ...
    title: "Web Development in Toronto | DesignNCode",
    description: "Enterprise full-stack web development and Next.js cloud architecture in Toronto. Sub-second performance, AODA WCAG 2.2 AA compliance, and Bay Street fintech scalability.",
    images: ["https://designncode.com/images/infographics/web-development-toronto.jpg"],
  },
};
    ...
    "@graph": [
      {
        ...
        "@id": "https://designncode.com/services/web-development/toronto#organization",
        "name": "DesignNCode - Web Development Toronto",
        "url": "https://designncode.com/services/web-development/toronto",
        "logo": "https://designncode.com/LOGO.svg",
        "image": "https://designncode.com/images/infographics/web-development-toronto.jpg",
      ...
      {
        "@type": "Service",
        "@id": "https://designncode.com/services/web-development/toronto#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://designncode.com/services/web-development/toronto#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Web Development in Toronto",
            "item": "https://designncode.com/services/web-development/toronto"
          }
        ]
      },
      {
        "@type": "FAQPage",
        "@id": "https://designncode.com/services/web-development/toronto#faq",
        "mainEntity": [
          {
            "@type": "Question",
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-zinc-200/80 rounded-2xl overflow-hidden shadow-xs my-10 text-zinc-900">
              ...
              <div className="p-4 bg-zinc-50/80">
                <div className="rounded-xl overflow-hidden border border-zinc-200 bg-white">
                  <img
                    src="/images/infographics/web-development-toronto.jpg"
