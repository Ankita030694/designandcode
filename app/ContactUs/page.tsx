...
export default function ContactUs() {
  ...
  return (
    <main className="relative flex flex-col flex-1 min-h-screen pt-24 bg-transparent">
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        
        {/* Main Background Container Card */}
        <div className="w-full bg-white/90 backdrop-blur-md rounded-[32px] sm:rounded-[40px] p-6 sm:p-10 lg:p-12 border border-zinc-200/70 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            
            {/* Left Column (Desktop) / Top Content (Mobile): Heading & Subtitle */}
            <div className="lg:col-span-6 flex flex-col justify-start">
              ...
              {/* Client Logos Carousel (Desktop Only - In Left Column) */}
            ...
            {/* Right Column (Desktop) / Middle (Mobile): Contact Form Card */}
            <div className="lg:col-span-6 w-full">
              <div className="bg-[#FAF9F6] sm:bg-[#F7F6F3] rounded-[24px] sm:rounded-[28px] p-6 sm:p-8 md:p-10 shadow-xs border border-zinc-200/60">
            ...
            {/* Client Logos Carousel (Mobile Only - Positioned Below Form) */}
