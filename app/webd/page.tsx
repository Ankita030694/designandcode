      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-24 -mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <div className="group cursor-pointer flex flex-col justify-between">
            <div className="relative rounded-[28px] bg-gradient-to-br from-[#60a5fa]/20 via-[#38bdf8]/15 to-[#bae6fd]/30 p-6 sm:p-8 overflow-hidden border border-zinc-200/60 shadow-xs transition-transform duration-500 group-hover:scale-[1.01] group-hover:shadow-md aspect-[16/10] flex items-center justify-center">
              <div className="w-full h-full bg-white rounded-xl shadow-lg border border-white/80 overflow-hidden flex flex-col">
                <div className="flex items-center justify-between px-3 py-2 bg-zinc-900 text-white text-[10px] font-mono">
                  ...
                  <span className="bg-sky-500 text-white px-2 py-0.5 rounded text-[9px] font-sans font-bold">Headless CMS</span>
                </div>
                <div className="p-3 bg-zinc-50 flex-1 flex flex-col justify-between gap-2">
                  <div className="flex items-center justify-between text-xs font-bold text-zinc-800">
                    <span>Composable Architecture</span>
                    <span className="text-[10px] text-zinc-400 font-normal">Next.js + GraphQL</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-sky-500 text-white rounded-lg p-2 flex flex-col justify-center">
                      <span className="text-[9px] opacity-90">Core Web Vitals</span>
                      <span className="text-[10px] font-bold">99/100 SPEED</span>
                    </div>
                    <div className="bg-white border border-zinc-200 rounded-lg p-2 flex flex-col justify-center">
                      <span className="text-[9px] text-zinc-400">Edge Caching</span>
                      <span className="text-[10px] font-bold text-zinc-700">Global CDN</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Project 2: Amplifidor */}
          <div className="group cursor-pointer flex flex-col justify-between">
            <div className="relative rounded-[28px] bg-gradient-to-br from-[#f472b6]/15 via-[#a78bfa]/10 to-[#fbcfe8]/25 p-6 sm:p-8 overflow-hidden border border-zinc-200/60 shadow-xs transition-transform duration-500 group-hover:scale-[1.01] group-hover:shadow-md aspect-[16/10] flex items-center justify-center">
              <div className="w-full h-full bg-white rounded-xl shadow-lg border border-white/80 overflow-hidden flex flex-col">
                <div className="flex items-center justify-between px-3 py-2 bg-zinc-900 text-white text-[10px] font-mono">
                  <span className="font-sans font-bold text-xs text-pink-400">AMPLIFIDOR</span>
                  <span className="bg-pink-500 text-white px-2 py-0.5 rounded text-[9px] font-sans font-bold">Platform</span>
                </div>
                <div className="p-3 bg-zinc-50 flex-1 flex flex-col justify-between gap-2">
                  <div className="flex items-center justify-between text-xs font-bold text-zinc-800">
                    <span>Scalable Platform</span>
                    <span className="text-[10px] text-zinc-400 font-normal">React + Node</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-pink-500 text-white rounded-lg p-2 flex flex-col justify-center">
                      <span className="text-[9px] opacity-90">Design Tokens</span>
                      <span className="text-[10px] font-bold">ATOMIC UI</span>
                    </div>
                    <div className="bg-white border border-zinc-200 rounded-lg p-2 flex flex-col justify-center">
                      <span className="text-[9px] text-zinc-400">Uptime</span>
                      <span className="text-[10px] font-bold text-zinc-700">99.99%</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6">
              <h3 className="text-2xl font-semibold text-zinc-900 mb-2 transition-colors duration-300 group-hover:text-pink-600">
                Amplifidor
              </h3>
              <p className="text-zinc-500 text-sm leading-relaxed mb-4">
                Creating a scalable, user-focused platform using composable design systems and microservices.
              </p>
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-3 py-1 rounded-full bg-white border border-zinc-200 text-zinc-700 text-xs font-medium shadow-xs">
                  Development
                ...
                <span className="px-2.5 py-1 rounded-full bg-white border border-zinc-200 text-xs shadow-xs" title="Saudi Arabia">
                  🇸🇦
                </span>
              </div>
            </div>
