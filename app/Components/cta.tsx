...
export default function CTA() {
  return (
    <section className="relative bg-[#FCFCFD] py-20 lg:py-28 px-6 sm:px-8 lg:px-12 border-t border-zinc-100/50 overflow-hidden -mt-10">
        ...
        <div className="flex justify-center lg:justify-end w-full">
          <div className="relative w-full max-w-md rounded-2xl text-left overflow-hidden flex flex-col p-8 md:p-10 border border-zinc-200/60 bg-white">
            ...
            <div className="relative z-10 flex flex-col h-full space-y-6">
              ...
              <Link
                href="/ContactUs"
                className="w-full py-3.5 flex items-center justify-center gap-2.5 text-[15px] font-semibold text-white bg-zinc-950 hover:bg-zinc-900 rounded-xl transition-colors duration-250"
              >
